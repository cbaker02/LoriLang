...
/*
Plugin Name: MyWebfontsKit #794178
...
add_action( 'admin_init', array('MonotypeInstaller_794178','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MonotypeInstaller_794178','monotype_loadupWebfonts' ));
